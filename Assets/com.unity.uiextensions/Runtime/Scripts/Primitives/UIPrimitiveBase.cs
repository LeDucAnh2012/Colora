...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIPrimitiveBase : MaskableGraphic, ILayoutElement, ICanvasRaycastFilter
    {
        ...
        /// <summary>
        /// Image's textureGray comes from the UnityEngine.Image.
        /// </summary>
        ...
        public virtual bool IsRaycastLocationValid(Vector2 screenPoint, Camera eventCamera)
        {
            ...
            {
                Debug.LogError("Using clickAlphaThreshold lower than 1 on Image whose sprite textureGray cannot be read. " + e.Message + " Also make sure to disable sprite packing for this sprite.", this);
                return true;
            }
        }
